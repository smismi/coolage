<!doctype html>
    <html><head>
        ...
        jQuery.fn.hold=function(timeout,f){if(timeout&&typeof timeout=='function'){
            f = timeout;timeout = 30;}if(f&&typeof f=='function'){var timer=0;var fireStep=0;return this.each(function(){jQuery(this).mousedown(function(){fireStep=1,ctr=0,t=this;timer=setInterval(function(){ctr++;f.call(t,ctr);fireStep=2;
            },timeout);});clearMousehold=function(){clearInterval(timer);if(fireStep==1) f.call(this, 1);fireStep=0;};jQuery(this).mouseout(clearMousehold);jQuery(this).mouseup(clearMousehold);})}}
        ...
        <body>
            ...
            This script converts path coordinates to SVG root element's coordinate space, so that all transformations (in g elements) that are between path and root are applied
            </div>
            <table><tr><td style="min-width:200px">
                <div id="raphael"></div>
            </td>
                <td>
                    <b>Transform:</b>
                        ...
                        <input type="radio" name="target" value="g1">g1&nbsp;
                            <input type="radio" name="target" value="g2">g2&nbsp;
                                ...
                                <br>
                                    ...
                                    <div id="scpv_plus" class="button">Scale v +</div><br>
                                    ...
                                    <div id="trpv_plus" class="button">Translate v +</div><br>

                                        <div id="rop_minus" class="button">Rotate -</div>
                                        <div id="rop_plus" class="button">Rotate +</div><br>

                                            <div id="rem_myPath" class="button">Remove transformation of myPath</div><br>
                                                <div id="rem_g1" class="button">Remove transformation of g1</div><br>
                                                    <div id="rem_g2" class="button">Remove transformation of g2</div><br>

                                                        <div id="chpa" class="button">Change path data (d)</div><br>
                                                ...
                                                <b>Path coordinates:</b><br>
                                                    ...
                                                    <b>Path coordinates relative to SVG root element:</b><br>
                                                        ...
                                                        update_SVG_source();
                                                        $("#coords1").html($("#myPath").attr("d").replace(/,/g, ",  "));
                                                        $("#coords2").html($("#myPath_normalized").attr("d").replace(/,/g, ",  "));
